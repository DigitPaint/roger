    ...
    module GetCallable
      ...
      def get_callable(callable, map)
        ...
        if callable.respond_to?(:call)
          ...
          fail ArgumentError, "Could not resolve #{callable.inspect}. Callable must be an object that responds to #call or a symbol that resolve to such an object or a class with a #call instance method."
        end
      end
    end
  end
